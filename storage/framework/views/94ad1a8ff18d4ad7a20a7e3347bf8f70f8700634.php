            ...
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <li><a href="#product" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-list"></i><span><?php echo e(__('file.product')); ?></span><span></a>
                <ul id="product" class="collapse list-unstyled ">
                  ...
                  <li id="product-list-menu"><a href="<?php echo e(route('products.index')); ?>"><?php echo e(__('Gestion de produit')); ?></a></li>
                  <?php 
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="<?php echo e(route('purchases.index')); ?>" > <i class="dripicons-card"></i><span><?php echo e(trans('file.Purchase')); ?></span></a>
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-cart"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  <?php if($index_permission_active): ?>
                  <li id="sale-list-menu"><a href="<?php echo e(route('sales.index')); ?>"><?php echo e(trans('Gestion de remise ')); ?></a></li>
                  <?php 
              ...
              <li><a href="#expense" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-wallet"></i><span><?php echo e(trans('file.Expense')); ?></span></a>
                <ul id="expense" class="collapse list-unstyled ">
                  ...
                  <li id="exp-list-menu"><a href="<?php echo e(route('expenses.index')); ?>"><?php echo e(trans('Gestion de depences')); ?></a></li>
                  <?php 
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="<?php echo e(route('quotations.index')); ?>" > <i class="dripicons-document"></i><span><?php echo e(trans('file.Quotation')); ?></span><span></a>
              ...
              ?>
              <?php if($index_permission_active): ?>
              <li><a href="<?php echo e(route('transfers.index')); ?>"  > <i class="dripicons-export"></i><span><?php echo e(trans('file.Transfer')); ?></span></a>
              ...
              <li><a href="#return" aria-expanded="false" data-toggle="collapse"> <i class="dripicons-archive"></i><span><?php echo e(trans('Retour')); ?></span></a>
